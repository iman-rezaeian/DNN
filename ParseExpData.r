...
library("illuminaHumanv4.db")
  ...
  St=read.table('table_S2.txt',header = TRUE,sep = "\t")
  Stage=St$stage

  Stage[which(Stage==1 | Stage==2 | Stage==3 | Stage==4)]=2
  Stage[which(Stage==0)]=1
  ...
  save(BC_Scores,file="BC_Scores_10Subtypes.RData")
